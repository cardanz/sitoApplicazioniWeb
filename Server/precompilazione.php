...
$stmt = $mysqli->prepare("SELECT users.username,users.firstname,users.lastname,users.city FROM `tokens` INNER JOIN users ON users.username = tokens.username WHERE token = ?");
